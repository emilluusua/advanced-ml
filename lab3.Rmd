...
```{r echo=FALSE}
hist(particles[1, ], main = 'Particles at t = 1', xlab = 'Particle position', ylab = '# of particles')
```
...
```{r echo=FALSE}
hist(particles[34, ], main = 'Particles at t = 34', xlab = 'Particle position', ylab = '# of particles')
```
...
```{r echo=FALSE}
hist(particles[67, ], main = 'Particles at t = 67', xlab = 'Particle position', ylab = '# of particles')
```
...
```{r echo=FALSE}
hist(particles[100, ], main = 'Particles at t = 100', xlab = 'Particle position', ylab = '# of particles')
```
